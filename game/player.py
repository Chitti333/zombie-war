    ...
    def input(self):
        if not self.attacking:
            ...
            if keys[pygame.K_LCTRL]:
                self.attacking = True
                self.attack_time = pygame.time.get_ticks()
                style = list(magic_info.keys())[self.magic_index]
                strength = list(magic_info.values())[self.magic_index]["strength"] + self.stats["magic"]
                cost = list(magic_info.values())[self.magic_index]["cost"]
